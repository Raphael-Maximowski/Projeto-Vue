...
import { getStories } from "../../service/HttpService.js";
...
// Criando Array que Recebe as Requisições 
  ...
  methods: {
    async GetInfo() {
      const response = await getStories(); // Response Recebe os Valores de cada ID 
...
<template>
  <div id="main">
    ...
    <div class="stories" v-for="(requisition, index) in requisition" :key="index">
      <router-link :to="{ name: 'StoriesDetail', params: { id: requisition.id } }">
